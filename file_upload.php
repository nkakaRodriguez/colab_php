...
$conn=new PDO('mysql:host=localhost; dbname=company', 'root', '') or die(mysql_error());
  ...
  ">
		...
		<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
			...
			<tr>
				...
				<td>
					<button class="alert-success"><a href="downloadfile.php?filename=<?php echo $name;?>&f=<?php echo $row['fname'] ?>">Download</a></button>
				</td>
			</tr>
			<?php }?>
		</table>
